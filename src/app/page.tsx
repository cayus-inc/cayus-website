    ...
    <>
      ...
      >
        <div className="mx-auto max-w-[1160px]">
          <Reveal>
            <SectionHead
              eyebrow="Depth, not breadth"
              title="Full depth on one search. Not four searches, done shallow."
              sub="A generalist recruiter runs the same steps across a dozen open roles at once, so each one gets a fraction of the attention. We run one search at a time and take it all the way: sourced, qualified against your criteria, motivation verified, before you ever see a name."
              invert
            />
          </Reveal>
            ...
            <Reveal delay={0.12} direction="left">
              <div>
                <p className="mb-3 text-[0.7rem] font-semibold uppercase tracking-[0.16em] text-[#9c968a]">
                  A generalist agency: a dozen roles at once
                </p>
            ...
            <Reveal delay={0.18} direction="right">
              <div>
                ...
                >
                  ...
                  <span className="relative ml-auto text-[0.78rem] text-[#9c968a]">
                    The hire is yours to make
                  </span>
                </div>
              </div>
            </Reveal>
