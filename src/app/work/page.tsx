...
export default function WorkPage() {
  return (
    <>
      <Header />
      <div className="mx-auto max-w-[900px] overflow-x-hidden px-6 pb-16 pt-14 md:pt-20">
      ...
      <div className="mx-auto max-w-[900px] overflow-x-hidden px-6">
        <Reveal direction="left">
      ...
      <div className="mx-auto mt-14 max-w-[900px] overflow-x-hidden border-t border-border px-6 pt-14">
      ...
      <div className="mx-auto mt-14 max-w-[900px] overflow-x-hidden border-t border-border px-6 pb-28 pt-14">
        <Reveal direction="left">
